  ...
  var T = {
    ...
    ja: {
      ...
      pricing: {
        heading: '料金案内',
        badge:   '人気',
        ring:    { cat: 'リング手作り体験', meta1: '所要時間：40分〜1時間', meta2: '体験人数：1〜4名', meta3: '対象年齢：中学生以上' },
        order:   { cat: 'オーダーメイドリング', meta1: 'ご要望に合わせてデザイン', meta2: '詳細はLINEにてご相談' },
    ...
    en: {
      ...
      pricing: {
        heading: 'Pricing',
        badge:   'Popular',
        ring:    { cat: 'Ring Making Experience', meta1: 'Duration: 40 min – 1 hour', meta2: 'Group size: 1–4 guests', meta3: 'Age: Junior high and above' },
        order:   { cat: 'Custom Order Ring', meta1: 'Designed to your request', meta2: 'Inquire via LINE for details' },
    ...
    zh: {
      ...
      pricing: {
        heading: '价格介绍',
        badge:   '人气',
        ring:    { cat: '戒指手作体验', meta1: '所需时间：40分钟～1小时', meta2: '体验人数：1～4人', meta3: '适用年龄：初中生以上' },
    ...
    ko: {
      ...
      pricing: {
        heading: '요금 안내',
        badge:   '인기',
        ring:    { cat: '반지 수제 체험', meta1: '소요시간：40분~1시간', meta2: '체험 인원：1~4명', meta3: '대상 연령：중학생 이상' },
        order:   { cat: '맞춤 제작 반지', meta1: '요청에 맞게 디자인', meta2: '자세한 내용은 LINE으로 문의' },
